...
func TestClampUint1(t *testing.T) {
	// uint test
...
func TestClampUint2(t *testing.T) {
...
func TestClampInt1(t *testing.T) {
	// int test
	if Clamp(-10, -5, 5) != -5 {
		t.Fail()
	}
...
func TestClampInt2(t *testing.T) {
	if Clamp(11, 7, 10) != 10 {
		t.Fail()
	}
...
func TestClampPanic1(t *testing.T) {
	defer func() {
		if recover() == nil {
			t.Fail()
		}
...
func TestClampPanic2(t *testing.T) {
	defer func() {
		if recover() == nil {
			t.Fail()
		}
